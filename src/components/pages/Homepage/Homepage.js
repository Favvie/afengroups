			...
			<div className="features-section">
              ...
              <div></div>
						...
						<div className="feature">
							<div>
								...
								<p>
									In a situation where an educator uploads their course(s) on
									our platform, they will be incentivized for every course
									completion that their content holds.
								</p>
							</div>
						</div>
              ...
              <div></div>
							<div>
								...
								<p>
									Users can decide to purchase properties that are listed via
									AFEN and get a percentage discount on the transcation fee:
									money is escrowed upon sale and tax is paid to the government.
									Ownership is transferred to the buyer upon confirmation of all
									requirements.
								</p>
							</div>
						</div>
						...
						<div className="feature">
							<div>
								...
								<p>
									...
									tokens on our NFT marketplace, the get a percentage discount
									on transaction fees. Users also have the option of paying in
									other crypto currencies for the full transcation fees.
								</p>
							</div>
						</div>
					</div>
