...
import { getTokenData } from "../../../hooks/useGetTokenDetails";
const Homepage = () => {
  const decor = {
    textDecoration: "none",
  };
      ...
      <div className="features-section">
        ...
        <div className="features">
          <div className="feature-list">
            <div className="feature">
              ...
              <h4>STAKE & EARN</h4>
              <p>
                By staking AFEN tokens over a period of time, users can earn
                staking rewards based on interest accrued over time and the
                duration of their lock-up.
              </p>
            </div>
            <div className="feature">
              ...
              <p>
                When our users engage in transactions using AFEN tokens either
                on our platform or partnering platforms, we offer....
              </p>
            </div>
            <div className="feature">
              ...
              <p>
                In a situation where an educator uploads their course(s) on our
                platform, they will be incentivized for every course completion
                that their content holds.
              </p>
            </div>
            <div className="feature">
              ...
              <p>
                Users can decide to purchase properties that are listed via AFEN
                and get a percentage discount on the transcation fee: money is
                escrowed upon sale and tax is paid to the government. Ownership
                is transferred to the buyer upon confirmation of all
                requirements.
              </p>
            </div>
            <div className="feature">
              ...
              <p>
                When users to choose to conduct their transactions using AFEN
                tokens on our NFT marketplace, the get a percentage discount on
                transaction fees. Users also have the option of paying in other
                crypto currencies for the full transcation fees.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="nft-afro-section">
          <div className="afro-text">
            ...
            <p className="afro-p">
              AFRO X represents a confluence of modern, mystic and ancient
              African design as illustrated by stellar African Afromysterics and
              3D digital artist, Jesse Tomi, put together by the AFEN blockchain
              group with the help of African historians and ancient African art
              curators.
            </p>
            <p className="afro-p">
              AFROXNFTs represent the core of African existence, displaying a
              mixture of culture and futurism. The collection is represented by
